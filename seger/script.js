...
const MATERIALES_DESC = {
  ...
  'Custer Feldspar (feldespato potásico)':     'Feldespato potásico americano muy usado. Buena fuente de K₂O con moderada alúmina.',
  ...
  'Arcilla de bola (SiO2, Al2O3)':            'Arcilla plástica. Más impura que el caolín, aporta TiO₂ que puede dar tonos crema.',
  ...
  'Óxido de manganeso (MnO2)':                'Colorante marrón-violeta. Se usa con cobalto para negros o solo para marrones cálidos.',
  'Óxido de cromo (Cr2O3)':                   'Colorante verde opaco. Reacciona con zinc dando marrón, con estaño dando rosado.',
  ...
  'Rutilo (TiO2 + Fe2O3)':                    'TiO₂ impuro con hierro. Da texturas interesantes, veteados y efectos de cristalización.',
...
const MATERIALES_DB = {
  ...
  'Arcilla de bola (SiO2, Al2O3)':            { Al2O3:30.5, SiO2:52.8, TiO2:1.5 },
